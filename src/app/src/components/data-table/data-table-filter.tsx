          ...
          <PopoverTrigger asChild>
            ...
            >
              {selectedValues.length > 0 ? (
                ...
                <span className="text-gray-500 dark:text-gray-400">请选择值...</span>
              )}
            </Button>
          </PopoverTrigger>
    ...
    <Popover>
      ...
      >
        <div className="space-y-3">
          <h4 className="text-sm font-medium truncate">{`筛选 ${columnHeader}`}</h4>
                  ...
                  <div className="relative min-w-0 w-full">
                    ...
                    >
                      {multiSelectValues.length > 0 ? (
                        ...
                        <span className="text-zinc-500 dark:text-zinc-400">请选择值...</span>
                      )}
                    </Button>
                    {isMultiSelectOpen && (
      ...
      >
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <h4 className="text-sm font-medium">筛选</h4>
