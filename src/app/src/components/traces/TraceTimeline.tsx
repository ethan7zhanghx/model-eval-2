            ...
            >
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <div className="space-y-1">
                        <p className="text-xs">耗时：{formatDuration(span.duration)}</p>
                        <p className="text-xs">开始时间：{formatTimestamp(span.startTime)}</p>
                        {span.endTime && (
                          <p className="text-xs">结束时间：{formatTimestamp(span.endTime)}</p>
                        )}
                        {hasAttributes && (
                          <p className="text-xs italic">展开后可查看属性详情</p>
                        )}
                      </div>
                    </TooltipContent>
                  </Tooltip>
              ...
              <CollapsibleContent>
                <div className="ml-10 mt-2 mb-4 p-4 bg-muted/50 rounded border-l-[3px] border-primary">
                  <h4 className="text-sm font-semibold mb-2">Span 详情</h4>
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-4">
                    ...
                    {span.parentSpanId && (
                      <div>
                        <p className="text-xs text-muted-foreground">父 Span ID</p>
