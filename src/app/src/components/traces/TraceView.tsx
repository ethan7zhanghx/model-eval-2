  ...
  if (!hasAnySpans) {
    return (
      <div className="p-2">
        <Alert variant="info">
          <AlertContent>
            <AlertTitle>未收到 Span 数据</AlertTitle>
            <AlertDescription>
              <p>系统已收到 Trace，但没有收到 Span。请确认你的 Provider：</p>
              <ul className="mt-2 ml-4 list-disc space-y-1">
                <li>已配置将 Trace 发送到 OTLP 端点（http://localhost:4318）</li>
                <li>会在当前 Trace 上下文中创建 Span</li>
                <li>会在评测结束前正确导出 Span</li>
              </ul>
            </AlertDescription>
          </AlertContent>
        </Alert>
