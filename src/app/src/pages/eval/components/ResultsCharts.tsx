          ...
          tooltip: {
            callbacks: {
              ...
              label(context) {
                ...
                return `${lowerBound} ≤ 分数 < ${upperBound}`;
              },
            },
          },
        },
          ...
          tooltip: {
            callbacks: {
              label(tooltipItem: TooltipItem<'scatter'>) {
                ...
                let prompt1Text = row.outputs[0]?.text || '无输出';
                let prompt2Text = row.outputs[1]?.text || '无输出';
    ...
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>对比不同 Prompt 的输出</DialogTitle>
          </DialogHeader>
