...
/** Request body for fetching model ids for a supported provider source. */
export const ProviderModelsRequestSchema = z.object({
  source: z.enum(['openrouter', 'openai-compatible']),
...
export const ProviderSchemas = {
  ...
  Models: { Request: ProviderModelsRequestSchema },
